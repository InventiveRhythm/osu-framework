...
namespace osu.Framework.Graphics.Containers
{
    ...
    public abstract partial class CompositeDrawable : Drawable
    {
        ...
        /// </summary>
        protected virtual bool RequiresChildrenUpdate => ForceChildUpdate || !IsMaskedAway || !childrenSizeDependencies.IsValid;

        protected virtual bool ForceChildUpdate => Parent?.ForceChildUpdate ?? false;
